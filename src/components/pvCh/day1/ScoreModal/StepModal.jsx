...
import star1 from "../../../../assets/images/pv-challenge/star_1.svg";
import star2 from "../../../../assets/images/pv-challenge/star_2.svg";
import audioW from "../../../../assets/audio/success-fanfare-trumpets-6185.mp3";
...
const ScoreModal = ({ show, close = () => null , total =0,number_of_start=1, scoreDay}) => {
                ...
                <div className={style.step_modal}>
                    ...
                    <div className={style.score_body}>
                        <div className={style.score_start}>
                            {[...Array(scoreDay?.stars).keys()].map(()=>{

                                return <img src={start2} width={100} alt={""} />
                            })}
                            {/*{[...Array(3-scoreDay?.stars).keys()].map(()=>{*/}

                            {/*    return <img src={start1} width={68} alt={""} />*/}
                            {/*})}*/}
                        </div>
