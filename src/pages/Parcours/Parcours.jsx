...
export default function Parcours() {
    ...
    const [listLevles, setListLevels] = useState([
        { left: "left-[12%]", top: "top-[78%]", img: img1, statue: 0, numberOfStart: 0, },
        { left: "left-[21%]", top: "top-[26%]", img: img2, statue: -1, numberOfStart: 0, },
        { left: "left-[35%]", top: "top-[79%]", img: img3, statue: -1, numberOfStart: 0, },
        { left: "left-[49%]", top: "top-[38%]", img: img4, statue: -1, numberOfStart: 0, },
        { left: "left-[66%]", top: "top-[79%]", img: img5, statue: -1, numberOfStart: 0, },
        { left: "left-[70%]", top: "top-[22%]", img: img6, statue: -1, numberOfStart: 0, },
        { left: "left-[88%]", top: "top-[78%]", img: img7, statue: -1, numberOfStart: 0, directions: "right" },
    ...
    return (
        <div className={styles.mainBackground}>
            ...
            {listLevles.map((item, index) => <div key={index} className={twMerge(`absolute`, item.left, item.top)}>
